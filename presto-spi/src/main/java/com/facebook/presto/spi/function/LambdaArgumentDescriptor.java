...
public class LambdaArgumentDescriptor
{
     ...
     * value.
     */
    private final Function<Set<Subfield>, Optional<Set<Subfield>>> lambdaArgumentToInputTransformationFunction;

    public LambdaArgumentDescriptor(int callArgumentIndex, Function<Set<Subfield>, Optional<Set<Subfield>>> lambdaArgumentToInputTransformationFunction)
    {
    ...
    public Function<Set<Subfield>, Optional<Set<Subfield>>> getLambdaArgumentToInputTransformationFunction()
    {
