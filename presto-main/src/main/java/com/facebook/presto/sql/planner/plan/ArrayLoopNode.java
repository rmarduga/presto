        ...
        extends InternalPlanNode
{
    ...
    {
        return visitor.visitArrayLoop(this, context);
    }

    @Override
    public PlanNode replaceChildren(List<PlanNode> newChildren)
    {
        return new ArrayLoopNode(getSourceLocation(), getId(), getStatsEquivalentPlanNode(), Iterables.getOnlyElement(newChildren), replicateVariables, unnestVariables, ordinalityVariable);
    }

    @Override
    public PlanNode assignStatsEquivalentPlanNode(Optional<PlanNode> statsEquivalentPlanNode)
    {
        return new ArrayLoopNode(getSourceLocation(), getId(), statsEquivalentPlanNode, source, replicateVariables, unnestVariables, ordinalityVariable);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ArrayLoopNode that = (ArrayLoopNode) o;
